...
class SongsTableViewController: TableViewWithMusicPlayerBarTableViewController  {
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.main.async {
            self.tabBarController?.presentPopupBar(withContentViewController:
                self.playerViewController, animated: true, completion: nil)
        }
    ...
    override func tableView( _ tableView: UITableView, cellForRowAt indexPath:IndexPath ) -> UITableViewCell {
        ...
        if let mediaValues = mediaDictionary[mediaKey]{
            ...
            if let image : MPMediaItemArtwork = mediaValues[indexPath.row].artwork{
